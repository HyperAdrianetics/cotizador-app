  ...
  return (
    <div className="w-full min-w-screen min-h-screen bg-gradient-to-br from-background via-primary-blue to-background text-white grid grid-rows-[auto_1fr_auto] p-6 relative overflow-hidden font-sans">
      ...
      <header className="w-full flex justify-between items-center py-4 z-10">
        ...
        <div className="text-xs text-primary-yellow/70 font-semibold bg-primary-yellow/5 px-3 py-1.5 rounded-full border border-primary-yellow/10">
          v1.0.0 Internal
        </div>
      </header>
      ...
      <main className="w-full flex flex-col items-center justify-center text-center z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-bold uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-white via-primary-yellow to-primary-yellow mb-4">
          Hypernetics Portal
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
          ...
          <Link
            to="/cotizador"
            className="group relative text-left p-8 rounded-2xl bg-primary-blue/60 border border-slate-800/80 hover:border-primary-yellow/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(210,210,175,0.05)] overflow-hidden"
          >
            ...
            <div className="w-12 h-12 rounded-xl bg-slate-800/50 flex items-center justify-center mb-6 group-hover:bg-primary-yellow/10 border border-slate-700/50 group-hover:border-primary-yellow/20 transition-all">
              <FileText className="w-6 h-6 text-slate-400 group-hover:text-primary-yellow transition-colors" />
            </div>
            
            <h2 className="text-xl font-bold text-white group-hover:text-primary-yellow transition-colors flex items-center gap-2 mb-2">
              Cotizador
