...
export const QuoteList: React.FC<QuoteListProps> = ({
  ...
  return (
    <Modal
      title="Cotizaciones"
      icon={<FolderOpen className="w-5 h-5 text-primary-green" />}
      onClose={onClose}
    ...
    >
      <div className="flex gap-2 mb-4">
        <button
          onClick={onNew}
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-primary-green/10 text-primary-green hover:bg-primary-green/20 transition-colors"
        >
