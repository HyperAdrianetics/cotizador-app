      ...
      {data.includeQuotePage && (
        ...
        >
              ...
              {data.logo ? (
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <div
                      className="w-10 h-10 rounded-full bg-primary-green"
                  ...
                  <div className="flex flex-col leading-tight">
                    ...
                    <span
                      className={`text-xl font-light italic block -mt-1 ${isDarkMode ? "text-primary-green" : "text-slate-500"}`}
                      style={{
          ...
          >
            <div className="mb-6">
              <p
                className={`text-sm font-bold uppercase tracking-widest ${isDarkMode ? "text-primary-green" : "text-slate-400"}`}
              >
                Atención a:
              </p>
              <h2
