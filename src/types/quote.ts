...
export interface QuoteData {
  ...
  notIncluded: string[];
  includeQuotePage: boolean;
  includeScopePage: boolean;
  milestones: { title: string; time: string; deliverable: string }[];
  platformCost?: { name: string; cost: string; period: string };
  portfolio: { title: string; link: string; description: string }[];
  paymentConditions: string[];
  addons?: { service: string; cost: string }[];
...
export const genericMilestones = [
  {
    title: "Fase 1: Planeación y Diseño",
    time: "Semana 1-2",
    deliverable: "Propuesta Visual y Wireframes",
  },
  {
    title: "Fase 2: Desarrollo y CMS",
    time: "Semana 3-4",
    deliverable: "Sitio funcional y carga de contenido",
  },
  {
    title: "Fase 3: Pruebas y Lanzamiento",
    time: "Semana 5",
    deliverable: "Capacitación y Publicación Final",
  },
];

export const genericPortfolio = [
  {
    title: "Fundación Uriel",
    link: "fundacionuriel.org",
    description: "Plataforma para organización sin fines de lucro.",
  },
  {
    title: "Semilleros de Sentido",
    link: "semillerosdesentido.org",
    description: "Sitio institucional educativo y social.",
  },
  {
    title: "Loto Audio",
    link: "lotoaudio.com.mx",
    description: "Portafolio para estudio de post-producción sonora.",
  },
  {
    title: "Misión Antigua",
    link: "misionantigua.org",
    description: "Plataforma de comunicación social e impacto.",
  },
  {
    title: "Mars Siege",
    link: "mars-siege-angular.vercel.app",
    description: "Plataforma interactiva de visualización y datos.",
  },
  {
    title: "Worktric",
    link: "worktric.com.mx",
...
export const HYPERNETICS_TEMPLATES = [
  {
    ...
    milestones: [
      {
        title: "Fase 1: Kickoff y Diseño",
        time: "Semana 1-2",
        deliverable:
          "Mapa del sitio, diseño base adaptado a branding y prototipo de alta fidelidad.",
      },
      {
        title: "Fase 2: Desarrollo y CMS",
        time: "Semana 3-4",
        deliverable:
          "Sitio completo maquetado, configuración CMS e integración de contenidos dinámicos.",
      },
      {
        title: "Fase 3: QA y Liberación",
        time: "Semana 5",
        deliverable:
          "Sitio publicado, capacitación y manual básico de administración.",
      },
    ],
    ...
    addons: [
      {
        service: "Extensiones de formularios premium",
        cost: "$1,000 – $2,000/año",
      },
      {
        service: "Integración newsletter (Mailchimp)",
        cost: "$0 – $3,000/año",
      },
    ],
    items: [
      {
        id: "1",
        description:
          "Fase 1: Planeación, diseño y configuración\nRevisión de brief, arquitectura y diseño visual adaptado.",
        quantity: 1,
        price: 11500,
      },
      {
        id: "2",
        description:
          "Fase 2: Desarrollo\nMaquetación de páginas, configuración CMS e integración de servicios.",
        quantity: 1,
        price: 15500,
      },
      {
        id: "3",
        description:
          "Fase 3: Entrega\nQA, pruebas, capacitación y publicación.",
        quantity: 1,
        price: 3750,
      },
      {
        id: "4",
        description:
          "Soporte post-lanzamiento\n2 meses de acompañamiento y ajustes menores.",
        quantity: 1,
        price: 3000,
      },
    ],
    ...
    milestones: [
      {
        title: "Fase 1: Kickoff y Diseño",
        time: "Semana 1-2",
        deliverable: "Wireframe funcional, diseño visual y prototipo aprobado.",
      },
      {
        title: "Fase 2: Desarrollo y CMS",
        time: "Semana 3-4",
        deliverable:
          "Sitio interactivo completo, colecciones dinámicas e integración de formularios.",
      },
      {
        title: "Fase 3: QA y Liberación",
        time: "Semana 5",
        deliverable: "Sitio publicado y capacitación al equipo.",
      },
    ],
    portfolio: [...genericPortfolio],
    paymentConditions: [
    ...
    items: [
      {
        id: "1",
        description:
          "Fase 1: Planeación y estructura\nDiseño visual y setup inicial de plataforma.",
        quantity: 1,
        price: 10500,
      },
      {
        id: "2",
        description:
          "Fase 2: Desarrollo\nDesarrollo de páginas, CMS dinámico e integraciones.",
        quantity: 1,
        price: 15000,
      },
      {
        id: "3",
        description: "Fase 3: Entrega\nQA, capacitación y publicación.",
        quantity: 1,
        price: 3000,
      },
      {
        id: "4",
        description:
          "Soporte post-lanzamiento\n2 meses de acompañamiento técnico.",
        quantity: 1,
        price: 2500,
      },
    ],
    ...
    milestones: [
      {
        ...
        time: "Semana 1-2",
        deliverable:
          "Arquitectura del sitio, prototipo de alta fidelidad y validación de diseño.",
      },
      {
        title: "Fase 2: Desarrollo y CMS",
        time: "Semana 3-4",
        deliverable:
          "Sitio interactivo completo, CMS administrable y configuración de componentes.",
      },
      {
        title: "Fase 3: QA y Liberación",
        time: "Semana 5",
        deliverable: "Sitio publicado, capacitación y entrega final.",
      },
    ],
    portfolio: [...genericPortfolio],
    paymentConditions: [
    ...
    items: [
      {
        id: "1",
        description:
          "Fase 1: Planeación y Diseño UI\nArquitectura de información y diseño visual.",
        quantity: 1,
        price: 11500,
      },
      {
        id: "2",
        description:
          "Fase 2: Maquetación y CMS\nDesarrollo en Framer con CMS e integraciones.",
        quantity: 1,
        price: 15500,
      },
      {
        id: "3",
        description: "Fase 3: Entrega\nQA, capacitación y liberación.",
        quantity: 1,
        price: 4000,
      },
      {
  ...
  },
  {
    ...
    milestones: [
      {
        title: "Fase 1: Kickoff y Diseño",
        time: "Semana 1-2",
        deliverable: "Instalación base, definición visual y prototipo.",
      },
      {
        title: "Fase 2: Desarrollo y CMS",
        time: "Semana 3-4",
        deliverable:
          "Sitio interactivo completo, CMS y plugins configurados e integración de contenidos.",
      },
      {
        title: "Fase 3: QA y Liberación",
        time: "Semana 5",
        deliverable: "Publicación, capacitación y documentación.",
      },
    ],
    portfolio: [...genericPortfolio],
    paymentConditions: [
    ...
    platformCost: {
      name: "WordPress (Licencia base)",
      cost: "$0.00",
      period: "Software Libre",
    },
    addons: [
    ...
    items: [
      {
        id: "1",
        description:
          "Fase 1: Planeación y Diseño\nSetup de servidor, arquitectura y diseño visual.",
        quantity: 1,
        price: 9500,
      },
      {
        id: "2",
        description:
          "Fase 2: Desarrollo\nDesarrollo base, CMS y configuración de plugins.",
        quantity: 1,
        price: 14500,
      },
      {
...
export const defaultQuote: QuoteData = {
  ...
  portfolio: HYPERNETICS_TEMPLATES[2].portfolio,
  paymentConditions: HYPERNETICS_TEMPLATES[2].paymentConditions,
  platformCost: HYPERNETICS_TEMPLATES[2].platformCost,
  addons: HYPERNETICS_TEMPLATES[2].addons,
  includeDetailsPage: true,
  clientName: HYPERNETICS_TEMPLATES[2].clientName,
  company: HYPERNETICS_TEMPLATES[2].company,
  date: getTodayDate(),
  folio: "HN-1001",
  deliveryTime: HYPERNETICS_TEMPLATES[2].deliveryTime,
  validity: "30 días naturales",
  clauses: [...hyperneticsClauses],
  observations: "*PRECIOS EXPRESADOS EN MXN. NO INCLUYE IVA.",
  items: HYPERNETICS_TEMPLATES[2].items,
  ...
  packageName: HYPERNETICS_TEMPLATES[2].packageName,
  note: HYPERNETICS_TEMPLATES[2].note,
